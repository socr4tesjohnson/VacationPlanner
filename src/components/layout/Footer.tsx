    ...
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">with Whitney World Travel</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Your personal Disney & Universal expert for stress-free family vacations
            </p>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white">Connect with Laura</h4>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Laura Coleman Travel. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
