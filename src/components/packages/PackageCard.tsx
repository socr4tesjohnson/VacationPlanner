...
export default function PackageCard({
  ...
  return (
    <Link
      href={`/packages/${slug}`}
      className="group block focus:outline-none focus:ring-4 focus:ring-blue-500/50 rounded-xl"
    >
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl hover:border-blue-200 transition-all duration-300 h-full flex flex-col">
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <p className="text-gray-600 mb-5 line-clamp-2 text-sm leading-relaxed flex-1">
            {shortDescription}
          </p>
