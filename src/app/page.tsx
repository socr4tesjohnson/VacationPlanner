        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-700 text-lg max-w-2xl mx-auto">
              Handpicked destinations and experiences curated by our travel experts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredPackages.map((pkg) => (
              <PackageCard
                ...
                imageAlt={pkg.images[0]?.altText || `${pkg.title} vacation package in ${pkg.destination}`}
                type={pkg.type}
          ...
          <div className="text-center mt-16">
            <Button asChild variant="primary" size="lg" className="shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 focus:ring-4 focus:ring-blue-500/50">
