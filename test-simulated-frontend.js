...
const tests = [
  ...
  },
  {
    ...
    payload: {
      quotedAmount: 12500.5,
      commissionRate: 10,
      commissionAmount: 1250.05,
    },
  },
  {
...
async function runAllTests() {
  ...
  console.log(
    "║  TESTING CLIENT MANAGEMENT FEATURES - SIMULATED FRONTEND     ║"
  );
  console.log(
    "╚══════════════════════════════════════════════════════════════╝\n"
  );
  ...
  console.log(
    "- commissionRate:",
    inquiry.commissionRate?.toString() || "(null)"
  );
  console.log(
    "- commissionAmount:",
    inquiry.commissionAmount?.toString() || "(null)"
  );
  console.log(
    "- checklist:",
    inquiry.checklist ? `Present (${inquiry.checklist.length} chars)` : "(null)"
  );
