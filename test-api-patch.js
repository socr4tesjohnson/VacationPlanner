...
async function runTests() {
  ...
  console.log('-------------------');
  const notesTest = await testPatch('notes', 'This is a test note for the Martinez family. They want a family suite.');
  ...
  console.log('-------------------');
  const quoteTest = await testPatch('quotedAmount', 12500.50);
  console.log('Status:', quoteTest.status);
  console.log('Success:', quoteTest.response.success);
  console.log('Updated quotedAmount:', quoteTest.response.inquiry?.quotedAmount);
  console.log('');
  ...
  console.log('Updated commissionRate:', rateTest.response.inquiry?.commissionRate);
  console.log('');
  ...
  console.log('Updated commissionAmount:', commissionTest.response.inquiry?.commissionAmount);
  console.log('');
  ...
  console.log('- checklist:', inquiry.checklist ? inquiry.checklist.substring(0, 50) + '...' : null);
